...
<div class="container">
    ...
    <table class="table">
        <tbody>
            <tr>
                <td>
                    <img src="./resources/images/image3.jpg" width="100" height="100">
                </td>
                <td>
    ...
    <table class="table">
        <tbody>
            <tr>
                <td>
                    <img src="./resources/images/image4.jpg" width="100" height="100">
                </td>
                <td>
    ...
    <table class="table">
        <tbody>
            <tr>
                <td>
                    <img src="./resources/images/image5.jpg" width="100" height="100">
                </td>
                <td>
    ...
    <ol>
        ...
        <li>
            ...
            <ul>
                <li>Underpunkt</li>
                <li>Enda eitt underpunkt</li>
            </ul>
        </li>
        <li>Err. elva er fin?</li>
        <li>godt tillaget for sykkel</li>
        <li>Flott å gå...</li>
    </ol>

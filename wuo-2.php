...
<div class="container">
    ...
    <h2>Magno hic ingenio, sed res se tamen sic habet</h2>
    <p>
        Ut nimis imperiosi philosophi sit vetare meminisse. Quis est autem dignus nomine hominis, qui unum diem totum velit esse in genere isto voluptatis? Non enim ipsa genuit hominem, sed accepit a natura inchoatum. Ita similis erit ei finis boni, atque antea fuerat, neque idem tamen; In motu et in statu corporis nihil inest, quod animadvertendum esse ipsa natura iudicet? Hos contra singulos dici est melius. Sed id ne cogitari quidem potest quale sit, ut non repugnet ipsum sibi.
    </p>

    <h2>Si quae forte-possumus</h2>
    <p>
    ...
    <!-- 11/11/2016 - Sondre Grøneng (Redid everything) -->
</div>
